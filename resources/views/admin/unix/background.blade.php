				...
				<div class="box-body">
				  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div>
                          <select class="form-control" name="loginbgtype">
						...
						<div class="form-group col-md-4">
						  ...
						  <div>
							<input type="text" class="form-control" name="login-bg-img" value="@isset($setting_data['login-bg-img']){{$setting_data['login-bg-img']}}@else https://wallpaperaccess.com/full/2002264.png @endisset" />
						...
						<div class="form-group col-md-4">
                            ...
                            <div>
                              <input type="text" class="form-control" name="login-bg-youtube" value="@isset($setting_data['login-bg-youtube']){{$setting_data['login-bg-youtube']}}@else edYCtaNueQY @endisset" />
						  ...
						  <div class="form-group col-md-4">
							...
							<div>
							  <select class="form-control" name="mainbgtype">
							...
							<div class="form-group col-md-4">
							  ...
							  <div>
								<input type="text" class="form-control" name="main-bg-img" value="@isset($setting_data['main-bg-img']){{$setting_data['main-bg-img']}}@else https://wallpaperaccess.com/full/2002264.png @endisset" />
