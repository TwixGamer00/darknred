...
<div class="row">
	<div class="col-xs-12">
		<div class="box">
            ...
            <iframe src="https://updates.mubeen.eu/{{ config('unix.name') }}/v={{ config('unix.version') }}" style="height:670px;width:100%;border:2px solid transparent;margin-top:20px;"> </iframe>
		</div>
	</div>
</div>
@endsection